...
class SunoApi {
  ...
  private async getAuthToken() {
    ...
    const getSessionUrl = `${SunoApi.CLERK_BASE_URL}/v1/client?_clerk_js_version=5.28.0`;                                                                                      
    // Get session ID
  ...
  public async keepAlive(isWait?: boolean): Promise<void> {
    ...
    const renewUrl = `${SunoApi.CLERK_BASE_URL}/v1/client/sessions/${this.sid}/tokens?_clerk_js_version==5.28.0`;  
    // Renew session token
